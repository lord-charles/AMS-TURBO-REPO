    ...
    <>
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">15 credits total this semester</p>
        </CardContent>
      </Card>
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">48 credits remaining to graduate</p>
        </CardContent>
      </Card>
    </>
  )
